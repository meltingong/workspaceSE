...
public class ReferenceVariableMain {
	...
	public static void main(String[] args) {
		...
		if(memberOne == memberThree) {
			System.out.println("주소값 동일하다 --> " +memberOne + " == " + memberThree );
		}
		if(memberTwo != memberOne) {
			System.out.println("주소값 다르다 --> " +memberOne + " != " + memberTwo );
		}
		System.out.println("-----------참조변수주소 swap------------");
		DuoMember m1 = new DuoMember(1000,"김경수");
		DuoMember m2 = new DuoMember(2000,"배고파");
		m1.print();
		m2.print();
		 ...
		 * null : 객체주소 리터럴 값
		 * 		- 객체주소값 초기화의 용도로 사용
		 * 		- null주소 사용시 NullPointException 발생
		 */
		if(m3 == null) {
			m3 = new DuoMember(3,"배고파");
			m3.print();
		}else{
			m3.print();
		}
