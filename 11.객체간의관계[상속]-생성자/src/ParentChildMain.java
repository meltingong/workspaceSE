class Parent	{
	...
	public Parent() {
		 ...
		 */
		super();
		System.out.println(" 1. Object()기본 생성자");
		System.out.println(" 2. Parent()기본 생성자");
	}
	...
	public Parent(int member1, int member2) {
		...
		System.out.println(" 1. public Objcet() 생성자 호출");
		System.out.println(" 2. public Parent(int member1, int member2) 생성자 호출");
	}
...
class Child extends Parent{
	...
	public Child(int member1, int member2, int member3) {
		/*
		<캡슐화 이후에는 아래와 같은 접근 불가능 하므로 super호출>
		this.member1 = member1;
		this.member2 = member2;
		*/
		super(member1, member2);
		this.member3 = member3;
		System.out.println(" 3. public Child(int member1, int member2, int member3) 생성자 호출");
	}
