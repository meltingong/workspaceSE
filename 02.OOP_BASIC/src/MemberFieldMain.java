...
public class MemberFieldMain {
	...
	public static void main(String[] args) {
		...
		/*
		 * MemberFeild 사용자정의 타입 객체의 주소값을 저장할 변수선언 (참조변수)
		 */
		MemberField mf1;
		/*
		 * MemberField클래스(틀)로 객체생성한 후에 객체의 참조변수 mf1에 생성된 객체의 주소값이 대입(#100)
		 */
		mf1 = new MemberField();
		 ...
		 * mf1(#100)주소에 있는 객체의 double	타입의 멤버변수 member2에 3.141592			값을 대입 
		 * mf1(#100)주소에 있는 객체의 char		타입의 멤버변수 member3에 'A'				값을 대입 
		 * mf1(#100)주소에 있는 객체의 String	타입의 멤버변수 member4에 "김수한무거북이~~"값을 대입
		 * 
		 *  - 객체의 참조(주소)변수가 가지고있는 객체의 주소값 #100를 사용해서 멤버필드에 데이타 대입
		 *  - 객체의 멤버필드 접근방법
		 *  	- 참조(주소)변수, 멤버필드 이름 = 값;
		 *  	- mf1.member1 = 77;
		 */
		 ...
		 * 
		 * - 객체의 참조(주소)변수가 가지고있는 객체의 주소값 #100를 사용해서 멤버필드의 값출력
		 *  - 객체의 멤버필드 접근방법
		 *  	1.System.our.println(mf1.member1);
		 *  	
		 *  	2.
		 *  	  int tempMember1 = mf1.member1;
		 * 		  System.our.println(tempMember1);
		 */
